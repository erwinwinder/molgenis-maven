...
<html>
	<head>
		...
		<link rel="stylesheet" style="text/css" href="res/css/colors.css" />
		<link rel="stylesheet" style="text/css" href="res/css/main.css" />
		<link rel="stylesheet" style="text/css" href="res/css/data.css" />
		<link rel="stylesheet" style="text/css" href="res/css/dateinput.css" />
		<link rel="stylesheet" style="text/css" href="res/css/xrefinput.css" />		
		<link rel="stylesheet" style="text/css" href="res/css/menu.css" />			
		<script language="JavaScript" type="text/javascript" src="res/scripts/all.js"></script>	
		<script src="res/scripts/popup.js" language="javascript"></script>	
		<script src="res/scripts/datetimeinput.js" language="javascript"></script>
		<script src="res/scripts/xrefinput.js" language="javascript"></script>
		<script src="res/scripts/mrefinput.js" language="javascript"></script>					
		<script src="res/scripts/menu.js" language="javascript"></script>	
