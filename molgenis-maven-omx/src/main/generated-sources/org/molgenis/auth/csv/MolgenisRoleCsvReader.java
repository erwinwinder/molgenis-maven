...
/* File:        org.molgenis/model/MolgenisRole.java
...
{
	private static final Logger logger = Logger.getLogger(MolgenisRoleCsvReader.class);
	...
	public int importCsv(final Database db, CsvReader reader, final Tuple defaults, final DatabaseAction dbAction, final String missingValues) throws DatabaseException, IOException, Exception 
	{
		...
		do
		{
			...
			List<MolgenisRole> resolvablemolgenisRoles = new ArrayList<MolgenisRole>(CollectionUtils.disjunction(molgenisRoles,
					molgenisRolesMissingRefs));
			...
			{
				throw new Exception(
						"Import of 'molgenisRole' objects failed: attempting to resolve in-list references,"
								+ "but after 100 iterations there are still molgenisRoles referring to Individuals that are neither in the database nor in the list of to-be imported molgenisRoles."
