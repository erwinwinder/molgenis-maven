...
{
	private static final Logger logger = Logger.getLogger(PanelCsvReader.class);
	...
	public int importCsv(final Database db, CsvReader reader, final Tuple defaults, final DatabaseAction dbAction, final String missingValues) throws DatabaseException, IOException, Exception 
	{
		...
		do
		{
			...
			List<Panel> resolvablepanels = new ArrayList<Panel>(CollectionUtils.disjunction(panels,
					panelsMissingRefs));
			...
			{
				throw new Exception(
						"Import of 'panel' objects failed: attempting to resolve in-list references,"
								+ "but after 100 iterations there are still panels referring to Individuals that are neither in the database nor in the list of to-be imported panels."
				...
				if(o.getIndividuals_Identifier() != null) 
				{
					...
					for(int i = 0; i < listSize; i++)
					{
						...
						if(individualsKeymap.get(key) == null){
							...
							throw new Exception("Import of 'Panel' objects failed: cannot find individuals_Identifier='"+(o.getIndividuals_Identifier() != null && i < o.getIndividuals_Identifier().size() ? o.getIndividuals_Identifier().get(i) : "null")+"'");
						}
