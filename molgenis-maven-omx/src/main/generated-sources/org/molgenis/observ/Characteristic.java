...
/**
 * Characteristic:  Characteristics are yes-no
...
//@EntityListeners({org.molgenis.observ.db.CharacteristicEntityListener.class})
public class Characteristic extends org.molgenis.util.AbstractEntity implements org.molgenis.core.Identifiable
{
	// fieldname constants
...
//	@javax.persistence.Lob()
	...
	public Characteristic()
	{
		...
		__Type_options.add(new org.molgenis.util.ValueLabel("SamplePanel","SamplePanel"));
		__Type_options.add(new org.molgenis.util.ValueLabel("AssayedPanel","AssayedPanel"));
		...
		__Type_options.add(new org.molgenis.util.ValueLabel("PhenotypeProperty","PhenotypeProperty"));
		__Type_options.add(new org.molgenis.util.ValueLabel("UsedMarkerSet","UsedMarkerSet"));
		...
		__Type_options.add(new org.molgenis.util.ValueLabel("FrequencyCluster","FrequencyCluster"));
		__Type_options.add(new org.molgenis.util.ValueLabel("GenotypeFrequency","GenotypeFrequency"));
		__Type_options.add(new org.molgenis.util.ValueLabel("AlleleFrequency","AlleleFrequency"));
		__Type_options.add(new org.molgenis.util.ValueLabel("PhenotypeMethod","PhenotypeMethod"));
		__Type_options.add(new org.molgenis.util.ValueLabel("Significance","Significance"));
		__Type_options.add(new org.molgenis.util.ValueLabel("EffectSize","EffectSize"));
		__Type_options.add(new org.molgenis.util.ValueLabel("DataSet","DataSet"));
		__Type_options.add(new org.molgenis.util.ValueLabel("Genome","Genome"));
		__Type_options.add(new org.molgenis.util.ValueLabel("Chromosome","Chromosome"));
		__Type_options.add(new org.molgenis.util.ValueLabel("Gene","Gene"));
		__Type_options.add(new org.molgenis.util.ValueLabel("Protein","Protein"));
		__Type_options.add(new org.molgenis.util.ValueLabel("ProteinDomain","ProteinDomain"));
		__Type_options.add(new org.molgenis.util.ValueLabel("Exon","Exon"));
		__Type_options.add(new org.molgenis.util.ValueLabel("Variant","Variant"));
	}
...
//2
    ...
    private java.util.Collection<org.molgenis.observ.ObservationSet> targetObservationSetCollection = new java.util.ArrayList<org.molgenis.observ.ObservationSet>();

	@javax.xml.bind.annotation.XmlTransient
	public java.util.Collection<org.molgenis.observ.ObservationSet> getTargetObservationSetCollection()
	{
            return targetObservationSetCollection;
	}

    public void setTargetObservationSetCollection(java.util.Collection<org.molgenis.observ.ObservationSet> collection)
    {
        for (org.molgenis.observ.ObservationSet observationSet : collection) {
            observationSet.setTarget(this);
        }
        targetObservationSetCollection = collection;
    }	
//2
	@javax.persistence.OneToMany(fetch=javax.persistence.FetchType.LAZY, mappedBy="characteristic"/*, cascade={javax.persistence.CascadeType.MERGE, javax.persistence.CascadeType.PERSIST, javax.persistence.CascadeType.REFRESH}*/)
    private java.util.Collection<org.molgenis.observ.ObservedValue> characteristicObservedValueCollection = new java.util.ArrayList<org.molgenis.observ.ObservedValue>();

	@javax.xml.bind.annotation.XmlTransient
	public java.util.Collection<org.molgenis.observ.ObservedValue> getCharacteristicObservedValueCollection()
	{
            return characteristicObservedValueCollection;
	}

    public void setCharacteristicObservedValueCollection(java.util.Collection<org.molgenis.observ.ObservedValue> collection)
    {
        for (org.molgenis.observ.ObservedValue observedValue : collection) {
            observedValue.setCharacteristic(this);
        }
        characteristicObservedValueCollection = collection;
    }	
