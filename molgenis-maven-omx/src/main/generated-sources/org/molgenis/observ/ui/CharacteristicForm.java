...
/* File:        Org.molgenis.omx/html/Characteristic.java
...
/**
 * A HtmlForm that is preloaded with all inputs for entity Characteristic
 * @see EntityForm
 */
public class CharacteristicForm extends EntityForm<Characteristic>
{
	...
	public CharacteristicForm(Characteristic entity)
	{
		super(entity);
	}
	...
	@Override
	public Class<Characteristic> getEntityClass()
	{
	...
	{	
		...
		//Id: Field(entity=Characteristic, name=id, type=int, auto=true, nillable=false, readonly=true, default=)
		{
			IntInput input = new IntInput("Characteristic_id",getEntity().getId());
		...
		{
			StringInput input = new StringInput("Characteristic_Identifier",getEntity().getIdentifier());
		...
		{
			StringInput input = new StringInput("Characteristic_Name",getEntity().getName());
		...
		{
			EnumInput input = new EnumInput("Characteristic___Type",getEntity().get__Type());
		...
		{
			TextInput input = new TextInput("Characteristic_description",getEntity().getDescription());
