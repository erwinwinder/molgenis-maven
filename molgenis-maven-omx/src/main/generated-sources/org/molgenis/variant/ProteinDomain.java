...
/* File:        org.molgenis.omx/model/ProteinDomain.java
...
/**
 * ProteinDomain: Serves as a view on SequenceCharacteristics that are
				protein domains.
...
@javax.persistence.Table(name = "ProteinDomain"
)

@org.hibernate.annotations.Table(appliesTo="ProteinDomain", indexes={
...
//@EntityListeners({org.molgenis.variant.db.ProteinDomainEntityListener.class})
public class ProteinDomain extends org.molgenis.observ.Characteristic implements org.molgenis.variant.CdnaPosition, org.molgenis.variant.GdnaPosition
{
	// fieldname constants
	...
	//static methods
	/**
	 * Shorthand for db.query(ProteinDomain.class).
	 */
	public static org.molgenis.framework.db.Query<? extends ProteinDomain> query(org.molgenis.framework.db.Database db)
	{
		return db.query(ProteinDomain.class);
	}
	
	/**
	 * Shorthand for db.find(ProteinDomain.class, org.molgenis.framework.db.QueryRule ... rules).
	 */
	public static java.util.List<? extends ProteinDomain> find(org.molgenis.framework.db.Database db, org.molgenis.framework.db.QueryRule ... rules) throws org.molgenis.framework.db.DatabaseException
	{
		return db.find(ProteinDomain.class, rules);
	}	
	
	/**
	 * 
	 */
	public static ProteinDomain findById(org.molgenis.framework.db.Database db, Integer id) throws org.molgenis.framework.db.DatabaseException
	{
		org.molgenis.framework.db.Query<ProteinDomain> q = db.query(ProteinDomain.class);
		q.eq(ProteinDomain.ID, id);
		java.util.List<ProteinDomain> result = q.find();
	 ...
	 * 
	 */
	public static ProteinDomain findByIdentifier(org.molgenis.framework.db.Database db, String identifier) throws org.molgenis.framework.db.DatabaseException
	{
		org.molgenis.framework.db.Query<ProteinDomain> q = db.query(ProteinDomain.class);
		q.eq(ProteinDomain.IDENTIFIER, identifier);
		java.util.List<ProteinDomain> result = q.find();
		if(result.size()>0) return result.get(0);
		else return null;
	}
...
//	@org.hibernate.search.annotations.Field(index=org.hibernate.search.annotations.Index.TOKENIZED, store=org.hibernate.search.annotations.Store.NO)
	...
	public void set( org.molgenis.util.Tuple tuple, boolean strict )  throws Exception
	{
		...
		else if(tuple != null)
		{
			...
			if( tuple.getInt("ProteinDomain_id") != null) this.setId(tuple.getInt("ProteinDomain_id"));
			//set Identifier
			if( strict || tuple.getString("Identifier") != null) this.setIdentifier(tuple.getString("Identifier"));
			if( tuple.getString("ProteinDomain_Identifier") != null) this.setIdentifier(tuple.getString("ProteinDomain_Identifier"));
			//set Name
			if( strict || tuple.getString("Name") != null) this.setName(tuple.getString("Name"));
			if( tuple.getString("ProteinDomain_Name") != null) this.setName(tuple.getString("ProteinDomain_Name"));
			//set __Type
			if( strict || tuple.getString("__Type") != null) this.set__Type(tuple.getString("__Type"));
			if( tuple.getString("ProteinDomain___Type") != null) this.set__Type(tuple.getString("ProteinDomain___Type"));
			//set Description
			if( strict || tuple.getString("description") != null) this.setDescription(tuple.getString("description"));
			if( tuple.getString("ProteinDomain_description") != null) this.setDescription(tuple.getString("ProteinDomain_description"));
			//set Cdna
			if( strict || tuple.getInt("cdna_id") != null) this.setCdna(tuple.getInt("cdna_id"));
			if( tuple.getInt("ProteinDomain_cdna_id") != null) this.setCdna(tuple.getInt("ProteinDomain_cdna_id"));
			//alias of xref
			if( tuple.getObject("cdna") != null) this.setCdna(tuple.getInt("cdna"));
			if( tuple.getObject("ProteinDomain_cdna") != null) this.setCdna(tuple.getInt("ProteinDomain_cdna"));
			...
			if( tuple.getObject("ProteinDomain_cdna_Identifier") != null ) this.setCdna_Identifier(tuple.getString("ProteinDomain_cdna_Identifier"));		
			//set Cdna_Start
			if( strict || tuple.getInt("cdna_start") != null) this.setCdna_Start(tuple.getInt("cdna_start"));
			if( tuple.getInt("ProteinDomain_cdna_start") != null) this.setCdna_Start(tuple.getInt("ProteinDomain_cdna_start"));
			//set Cdna_End
			if( strict || tuple.getInt("cdna_end") != null) this.setCdna_End(tuple.getInt("cdna_end"));
			if( tuple.getInt("ProteinDomain_cdna_end") != null) this.setCdna_End(tuple.getInt("ProteinDomain_cdna_end"));
			//set Gdna
			if( strict || tuple.getInt("gdna_id") != null) this.setGdna(tuple.getInt("gdna_id"));
			if( tuple.getInt("ProteinDomain_gdna_id") != null) this.setGdna(tuple.getInt("ProteinDomain_gdna_id"));
			//alias of xref
			if( tuple.getObject("gdna") != null) this.setGdna(tuple.getInt("gdna"));
			if( tuple.getObject("ProteinDomain_gdna") != null) this.setGdna(tuple.getInt("ProteinDomain_gdna"));
			...
			if( tuple.getObject("ProteinDomain_gdna_Identifier") != null ) this.setGdna_Identifier(tuple.getString("ProteinDomain_gdna_Identifier"));		
			//set Gdna_Start
			if( strict || tuple.getInt("gdna_start") != null) this.setGdna_Start(tuple.getInt("gdna_start"));
			if( tuple.getInt("ProteinDomain_gdna_start") != null) this.setGdna_Start(tuple.getInt("ProteinDomain_gdna_start"));
			//set Gdna_End
			if( strict || tuple.getInt("gdna_end") != null) this.setGdna_End(tuple.getInt("gdna_end"));
			if( tuple.getInt("ProteinDomain_gdna_end") != null) this.setGdna_End(tuple.getInt("ProteinDomain_gdna_end"));
		}
	...
	/**
	 * Get the names of all public properties of ProteinDomain.
	 */
	...
	public boolean equals(Object obj) {
		...
		ProteinDomain rhs = (ProteinDomain) obj;
	...
	@Override
	public ProteinDomain create(org.molgenis.util.Tuple tuple) throws Exception
	{
